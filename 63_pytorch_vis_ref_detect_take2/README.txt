...
summary of above:  The torchvision package consists of popular datasets, model architectures, and common image transformations for computer vision.

---------------------------
Training References
https://github.com/pytorch/vision/tree/main/references

summary of above: The training references are a sub-folder of vision/
I have cloned the vision/ tree here, so those references are found here.
Most of my focus will be on vision/dection to start
...
For windows... investigating torch.distributed.launch (the predecessor to torchrun) see https://pytorch.org/docs/stable/distributed.html#launch-utility
